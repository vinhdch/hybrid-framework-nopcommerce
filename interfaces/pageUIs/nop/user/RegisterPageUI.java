...
public class RegisterPageUI {
	...
	public static final String PASSWORD_ERROR_MESSAGE = "@id='assword-error";
	...
	public static final String EXIST_EMAIL_MESSAGE = "xpath=//div[contains(@class,'message-error')]//li";
